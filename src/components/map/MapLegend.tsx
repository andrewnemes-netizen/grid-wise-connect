  ...
  return (
    <div className="absolute bottom-4 right-14 z-10">
      <div className="rounded-lg border bg-background/95 backdrop-blur shadow-md">
        <button
          onClick={() => setOpen((v) => !v)}
          className="flex w-full items-center justify-between gap-3 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground hover:text-foreground transition-colors"
        >
          <span>Legend</span>
        ...
        {open && (
          <div className="px-3 pb-2 space-y-1.5 border-t border-border pt-1.5">
