  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const enrichedRawData = {
        ...
        total_estimate: costEstimate?.total_estimate ?? null,
        cost_confidence: costEstimate?.confidence ?? null,
        cost_band: costBand,
          ...
          {result && rawMetrics && (
            <>
              ...
              <div className="flex gap-2">
                ...
                >
                  {exportingPdf ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" />Capturing…</> : <><Download className="mr-2 h-4 w-4" />Export PDF</>}
                </Button>
                {!saved ? (
