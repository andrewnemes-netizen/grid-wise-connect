  ...
  const { data: cards = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select(`
          id, name, code, contract:contracts(id, name),
        ...
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          <div>
            ...
            <CardDescription>
              ...
              card to view or edit it in full.
            </CardDescription>
          </div>
            ...
            <Table>
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  <TableRow><TableCell colSpan={6} className="text-center text-muted-foreground py-8">No rate cards yet — add one above.</TableCell></TableRow>
