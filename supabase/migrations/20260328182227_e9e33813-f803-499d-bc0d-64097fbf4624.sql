...
BEGIN
  ...
  ELSIF p_dno = 'UKPN' THEN
    v_rules := '[
      ...
      {"slug":"ukpn-substation-loading","display_name":"UKPN Substation Loading","category":"Capacity","subcategory":"Loading","geometry_type":"Point","storage_table":"geo_substations","match_patterns":["%substation%loading%","%substation%headroom%"],"exclude_patterns":[]},
      ...
      {"slug":"ukpn-ecr","display_name":"UKPN Embedded Capacity Register","category":"Capacity","subcategory":"ECR","geometry_type":"Point","storage_table":"geo_substations","match_patterns":["%embedded%capacity%","%ecr%"],"exclude_patterns":[]},
      {"slug":"ukpn-connection-queue","display_name":"UKPN Connection Queue","category":"Connections","subcategory":"Queue","geometry_type":"Point","storage_table":"geo_substations","match_patterns":["%connection%queue%","%connection%offer%","%accepted%connection%"],"exclude_patterns":[]},
      ...
      {"slug":"ukpn-ndp","display_name":"UKPN Network Development Plan","category":"Capacity","subcategory":"NDP","geometry_type":"Point","storage_table":"geo_substations","match_patterns":["%network%development%","%ndp%","%reinforcement%"],"exclude_patterns":[]},
      {"slug":"ukpn-fault-data","display_name":"UKPN Fault & Interruption Data","category":"Performance","subcategory":"Faults","geometry_type":"Point","storage_table":"geo_points","match_patterns":["%fault%","%interruption%","%outage%","%power%cut%"],"exclude_patterns":[]},
      {"slug":"ukpn-transformers","display_name":"UKPN Transformers","category":"Network Assets","subcategory":"Transformers","geometry_type":"Point","storage_table":"geo_substations","match_patterns":["%transformer%"],"exclude_patterns":["%loading%","%headroom%"]},
      {"slug":"ukpn-dnoa","display_name":"UKPN DNOA","category":"Capacity","subcategory":"DNOA","geometry_type":"Point","storage_table":"geo_substations","match_patterns":["%dnoa%","%distribution%network%option%"],"exclude_patterns":[]}
    ]'::jsonb;

  ELSIF p_dno = 'CADENT' THEN
    v_rules := '[
      {"slug":"cadent-gas-pipes-lp","display_name":"Cadent LP Gas Pipes","category":"Gas Mains","subcategory":"Low Pressure","geometry_type":"LineString","storage_table":"geo_cables","match_patterns":["%gas%pipe%","%gpi%","%low%pressure%main%"],"exclude_patterns":["%medium%","%intermediate%","%high%"]},
      {"slug":"cadent-gas-pipes-mp","display_name":"Cadent MP Gas Pipes","category":"Gas Mains","subcategory":"Medium Pressure","geometry_type":"LineString","storage_table":"geo_cables","match_patterns":["%medium%pressure%"],"exclude_patterns":[]},
      {"slug":"cadent-gas-pipes-ip","display_name":"Cadent IP Gas Pipes","category":"Gas Mains","subcategory":"Intermediate Pressure","geometry_type":"LineString","storage_table":"geo_cables","match_patterns":["%intermediate%pressure%"],"exclude_patterns":[]},
      {"slug":"cadent-gas-pipes-hp","display_name":"Cadent HP Gas Pipes","category":"Gas Mains","subcategory":"High Pressure","geometry_type":"LineString","storage_table":"geo_cables","match_patterns":["%high%pressure%"],"exclude_patterns":[]},
      {"slug":"cadent-network-zones","display_name":"Cadent Network Zones","category":"Gas Boundaries","subcategory":"Network Zones","geometry_type":"Polygon","storage_table":"geo_polygons","match_patterns":["%network%zone%","%boundary%","%licence%area%","%supply%area%"],"exclude_patterns":[]},
      {"slug":"cadent-pressure-data","display_name":"Cadent Pressure Data","category":"Gas Capacity","subcategory":"Pressure","geometry_type":"Point","storage_table":"geo_points","match_patterns":["%pressure%"],"exclude_patterns":["%low%pressure%main%","%medium%pressure%","%intermediate%","%high%pressure%"]},
      {"slug":"cadent-gas-infrastructure","display_name":"Cadent Gas Infrastructure","category":"Gas Assets","subcategory":"Infrastructure","geometry_type":"LineString","storage_table":"geo_cables","match_patterns":["%gas-pipe-infrastructure%","%gpi_open%","%gpi-pipe%"],"exclude_patterns":[]},
  ...
  -- Process each unlinked geospatial dataset
  FOR v_dataset IN
    ...
    LOOP
      ...
      LOOP
        IF lower(v_dataset.dataset_id) LIKE v_match_pattern OR lower(v_dataset.title) LIKE v_match_pattern THEN
          ...
          -- Link dataset to layer and activate
