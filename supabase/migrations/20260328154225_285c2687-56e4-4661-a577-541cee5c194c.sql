...
DROP FUNCTION IF EXISTS public.auto_create_dno_layers(text, boolean);

CREATE FUNCTION public.auto_create_dno_layers(p_dno text, p_force boolean DEFAULT false)
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
