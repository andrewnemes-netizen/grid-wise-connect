...
DECLARE
  ...
  radii NUMERIC[] := ARRAY[2000, 5000, 15000];
  r NUMERIC;
BEGIN
  ...
  LOOP
    ...
    IF tmp_dist IS NOT NULL THEN
      ...
      nearest_primary_pt_4326 := ST_ClosestPoint(tmp_geom, site_4326);
      EXIT;
    END IF;
  END LOOP;

  -- Also check site_utilisation (SRID 27700)
  FOREACH r IN ARRAY ARRAY[2000, 5000, 15000]
  LOOP
  ...
  LOOP
    ...
    IF tmp_dist IS NOT NULL THEN
      ...
      nearest_feeder_pt_4326 := ST_ClosestPoint(tmp_geom, site_4326);
      EXIT;
    END IF;
  END LOOP;
  ...
  LOOP
    ...
    IF tmp_dist IS NOT NULL THEN
      ...
      nearest_cable_pt_4326 := ST_ClosestPoint(tmp_geom, site_4326);
      EXIT;
    END IF;
  END LOOP;
