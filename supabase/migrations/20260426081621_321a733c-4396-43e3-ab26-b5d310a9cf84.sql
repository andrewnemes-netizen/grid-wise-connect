...
BEGIN
  ...
  IF p_dno = 'SSEN' THEN
    v_rules := '[
      ...
      {"slug":"ssen-dx-gis-network-lines","display_name":"SSEN DX - GIS Network Lines","category":"Electrical Assets","subcategory":"Network Lines","geometry_type":"LineString","storage_table":"geo_cables","match_patterns":["%gis network line%","%gis_network_line%"],"exclude_patterns":[]},
      {"slug":"ssen-dx-primary-supply-areas","display_name":"SSEN DX - Primary Substation Supply Areas","category":"Boundaries","subcategory":"Primary Supply Areas","geometry_type":"Polygon","storage_table":"geo_polygons","match_patterns":["%primary substation%supply area%","%primary-substation-boundaries%"],"exclude_patterns":[]},
      {"slug":"ssen-dx-secondary-supply-areas","display_name":"SSEN DX - Secondary Substation Supply Areas","category":"Boundaries","subcategory":"Secondary Supply Areas","geometry_type":"Polygon","storage_table":"geo_polygons","match_patterns":["%secondary substation%supply area%","%secondary-substation-esa%"],"exclude_patterns":[]},
      {"slug":"ssen-dx-gsp-bsp-supply-areas","display_name":"SSEN DX - GSP & BSP Supply Areas","category":"Boundaries","subcategory":"GSP/BSP","geometry_type":"Polygon","storage_table":"geo_polygons","match_patterns":["%grid supply point%supply area%","%gsp%bsp%supply area%"],"exclude_patterns":[]},
      {"slug":"ssen-dx-licence-area","display_name":"SSEN DX - Distribution Licence Area Boundaries","category":"Boundaries","subcategory":"Licence Areas","geometry_type":"Polygon","storage_table":"geo_polygons","match_patterns":["%licence area boundaries%","%distribution licence area%"],"exclude_patterns":[]},
      {"slug":"ssen-dx-smart-meter-lv-feeder","display_name":"SSEN DX - Smart Meter LV Feeder Usage","category":"Performance","subcategory":"Smart Meter","geometry_type":"Point","storage_table":"geo_points","match_patterns":["%smart meter%lv feeder%","%smart_meter_prod_lv_feeder%"],"exclude_patterns":[]},
      {"slug":"ssen-dx-embedded-capacity-register","display_name":"SSEN DX - Embedded Capacity Register","category":"Network","subcategory":"Connected Generation","geometry_type":"Point","storage_table":"geo_points","match_patterns":["%embedded capacity register%","%embedded_capacity_register%"],"exclude_patterns":[]},
      ...
      {"slug":"ssen-dx-low-carbon-connections","display_name":"SSEN DX - Low Carbon Technology Connections","category":"Network","subcategory":"LCT Connections","geometry_type":"Point","storage_table":"geo_points","match_patterns":["%low carbon technolog%connection%","%low-carbon-technology-connections%"],"exclude_patterns":[]},
      {"slug":"ssen-dx-generation-availability","display_name":"SSEN DX - Generation Availability & Network Capacity","category":"Network","subcategory":"Capacity","geometry_type":"Point","storage_table":"geo_points","match_patterns":["%generation availability%network capacity%","%generation-availability-and-network-capacity%"],"exclude_patterns":[]},
      {"slug":"ssen-dx-realtime-outages","display_name":"SSEN DX - Real Time Outages","category":"Performance","subcategory":"Outages","geometry_type":"Point","storage_table":"geo_points","match_patterns":["%real time outage%","%realtime_outage%"],"exclude_patterns":[]}
    ]'::jsonb;
