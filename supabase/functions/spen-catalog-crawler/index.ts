...
/**
 * SPEN Catalog Crawler
 *
 * Discovers every dataset on the SP Energy Networks Opendatasoft portal
 * using the Explore API v2.1 catalog endpoint.
 */

const BASE_URL = "https://spenergynetworks.opendatasoft.com/api/explore/v2.1";
const PORTAL_BASE = "https://spenergynetworks.opendatasoft.com/explore/dataset";
const DNO_KEY = "SPEN";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const apiKey = body.api_key || Deno.env.get("SPEN_API_KEY") || null;

    console.log("[crawler] Starting SPEN catalog discovery...");
