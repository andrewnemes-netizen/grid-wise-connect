...
/**
 * UKPN Catalog Crawler
 *
 * Discovers datasets on the UK Power Networks Opendatasoft portal
 * using the Explore API v2.1 catalog endpoint.
 */

const BASE_URL = "https://ukpowernetworks.opendatasoft.com/api/explore/v2.1";
const PORTAL_BASE = "https://ukpowernetworks.opendatasoft.com/explore/dataset";
const DNO_KEY = "UKPN";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log("[crawler] Starting UKPN catalog discovery...");
