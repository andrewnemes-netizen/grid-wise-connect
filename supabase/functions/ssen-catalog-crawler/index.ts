...
/**
 * SSEN Catalog Crawler
 *
 * Discovers every dataset on the SSEN Transmission Opendatasoft portal
 * using the Explore API v2.1 catalog endpoint and upserts records into
 * dno_dataset_registry under the "SSEN" key.
 */

const BASE_URL = "https://ssentransmission.opendatasoft.com/api/explore/v2.1";
const PORTAL_BASE = "https://ssentransmission.opendatasoft.com/explore/dataset";
const DNO_KEY = "SSEN";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const apiKey = body.api_key || Deno.env.get("SSEN_API_KEY") || null;

    console.log("[crawler] Starting SSEN catalog discovery...");
