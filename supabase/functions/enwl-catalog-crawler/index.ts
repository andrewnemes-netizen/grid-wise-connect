...
/**
 * ENWL Catalog Crawler
 *
 * Discovers every dataset on the Electricity North West Opendatasoft portal
 * using the Explore API v2.1 catalog endpoint.
 */

const BASE_URL = "https://electricitynorthwest.opendatasoft.com/api/explore/v2.1";
const PORTAL_BASE = "https://electricitynorthwest.opendatasoft.com/explore/dataset";
const DNO_KEY = "ENWL";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const apiKey = body.api_key || Deno.env.get("ENWL_API_KEY") || null;

    console.log("[crawler] Starting ENWL catalog discovery...");
